...
app.post("/", function (req, res) {
	...
	// CONDITION FOR BMI
	if (bmi < 19) {
		res.send("<h3>HIE! " + req_name +
				" your BMI is : " + bmi +
				"<centre><h1>You are Underweight, add healthy foods in your diet");
	} else if (19 <= bmi && bmi < 25) {
		res.send("<h3>HIE! " + req_name +
				" your BMI is : " + bmi +
				"<centre><h1>You are Normalweight, Good");
	} else if (25 <= bmi && bmi < 30) {
		res.send("<h3>HIE! " + req_name +
				" your BMI is : " + bmi +
				"<centre><h1>You are Overweight , add workouts in your daily routine");
	} else {
		res.send("<h3>HIE! " + req_name +
				" your BMI is : " + bmi +
				"<centre><h1>You are Obese , eat healthy foods ");
	}
});
